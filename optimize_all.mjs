...
const mkultra = JSON.parse(
  fs.readFileSync('src/data/articles/real-mkultra-experiments-stranger-things.json', 'utf-8')
);
...
fs.writeFileSync(
  'src/data/articles/real-mkultra-experiments-stranger-things.json',
  JSON.stringify(mkultra, null, 2)
);
console.log('✓ Article 1 optimized');

// Article 2: Stanley Hotel
console.log('Optimizing Article 2: Stanley Hotel...');
const stanley = JSON.parse(
  fs.readFileSync('src/data/articles/the-shining-stanley-hotel-true-story.json', 'utf-8')
);
...
fs.writeFileSync(
  'src/data/articles/the-shining-stanley-hotel-true-story.json',
  JSON.stringify(stanley, null, 2)
);
console.log('✓ Article 2 optimized');

// Article 3: Princes in the Tower
console.log('Optimizing Article 3: Princes in the Tower...');
const princes = JSON.parse(
  fs.readFileSync('src/data/articles/princes-in-the-tower-mystery.json', 'utf-8')
);
...
fs.writeFileSync(
  'src/data/articles/princes-in-the-tower-mystery.json',
  JSON.stringify(princes, null, 2)
);
console.log('✓ Article 3 optimized');

// Article 4: Horror Movies
console.log('Optimizing Article 4: Horror Movies...');
const horror = JSON.parse(
  fs.readFileSync('src/data/articles/best-horror-movies-based-on-true-stories.json', 'utf-8')
);
...
fs.writeFileSync(
  'src/data/articles/best-horror-movies-based-on-true-stories.json',
  JSON.stringify(horror, null, 2)
);
console.log('✓ Article 4 optimized');

// Article 5: Frankenstein
console.log('Optimizing Article 5: Frankenstein...');
const frankenstein = JSON.parse(
  fs.readFileSync('src/data/articles/frankenstein-origin-story-lake-geneva.json', 'utf-8')
);
...
fs.writeFileSync(
  'src/data/articles/frankenstein-origin-story-lake-geneva.json',
  JSON.stringify(frankenstein, null, 2)
);
