---
title: 'London Ghost Tours: Jack the Ripper & Beyond | Cursed Tours'
hubSlug: london-ghost-tours
city: London
tourKey: london
metaDescription: Explore London's haunted history through ghost tours covering Jack
  the Ripper, the Tower of London, plague pits, and centuries of documented hauntings.
heroImage: /images/heroes/london-hero.webp
latitude: 51.5074
longitude: -0.1278
region: England
country: GB
...
- id: plague
  icon: 💀
  label: Plague History
- id: royal
  icon: 👑
  label: Royal Ghosts
faqs:
- question: Where do Jack the Ripper tours take place?
  answer: Ripper tours walk through Whitechapel and Spitalfields in East London, visiting
    the documented locations of the 1888 murders. While the original streets have
    been substantially rebuilt, key landmarks and the geography of the case remain
    navigable. Tours typically last 90 minutes to two hours.
- question: Is the Tower of London really haunted?
  answer: The Tower has generated reports of apparitions for over 500 years. Anne
    Boleyn, Lady Jane Grey, and the Princes in the Tower are among the most frequently
    reported figures. Yeoman Warders (Beefeaters) who live on-site have documented
    unexplained experiences, and the Tower maintains records of reported sightings.
- question: Can you visit London plague pits?
  answer: Most plague pits are beneath existing buildings and streets. Charterhouse
    Square, identified as a mass burial site in 2013 during Crossrail excavations,
    is accessible as a public garden. Some tours visit churches and crypts built over
    confirmed burial sites, providing access to spaces where plague victims were interred.
- question: What is the best London ghost tour for history lovers?
  answer: Walking tours focused on specific historical periods tend to offer the most
...
<section class="py-16 md:py-20 bg-[#0a0510]">   <div class="container px-4 mx-auto max-w-4xl">
  ...
  <section class="py-16 md:py-20 bg-[#0f0a1a]">
    <div class="container px-4 mx-auto max-w-4xl">
      <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Why London Is Haunted</h2>
  ...
  <section id="jack-ripper" class="py-12 md:py-16 relative overflow-hidden">
    ...
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl md:text-3xl font-bold text-white">Jack the Ripper Tours</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        ...
        <div class="my-8 py-8 text-center bg-gradient-to-b from-purple-950/[0.12] via-purple-950/[0.04] to-transparent rounded-xl">
          ...
          <p class="text-sm text-[#a89bb8] mt-2 tracking-wide uppercase">CANONICAL VICTIMS OF JACK THE RIPPER</p>
        </div>
<p>
        ...
        <div class="my-8 border-l-4 border-purple-500/50 pl-6 pr-4 py-4 bg-purple-950/[0.15] rounded-r-lg">
          <p class="text-lg italic text-[#c4b5fd]/80">&ldquo;Jack the Ripper killed five women in the Whitechapel district over just ten weeks in the autumn of 1888, and the case remains unsolved.&rdquo;</p>
        </div>
        <p>
...
<section id="tower" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -right-24 top-1/3 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">🏰</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Tower of London</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
...
<section id="plague" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -right-16 bottom-1/4 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">💀</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Plague & Great Fire History</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
...
<section id="royal" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -left-20 bottom-1/3 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">👑</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Royal Ghost Tours</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
        ...
        <div class="my-8 py-8 text-center bg-gradient-to-b from-purple-950/[0.12] via-purple-950/[0.04] to-transparent rounded-xl">
          <div class="text-4xl md:text-5xl font-bold text-purple-400" style="font-family: 'Cinzel', serif; text-shadow: 0 0 30px rgba(168, 85, 247, 0.35), 0 0 60px rgba(168, 85, 247, 0.12);">2,000</div>
          <p class="text-sm text-[#a89bb8] mt-2 tracking-wide uppercase">YEARS OF RECORDED HAUNTINGS IN LONDON</p>
        </div>
        <p>
