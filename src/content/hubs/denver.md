---
title: 'Denver Ghost Tours: Mining Ghosts & Wild West | Cursed Tours'
hubSlug: denver-ghost-tours
city: Denver
tourKey: denver
metaDescription: Denver ghost tours through Cheesman Park's buried cemetery, the Brown
  Palace Hotel, LoDo saloons, and Colorado's frontier ghosts.
heroImage: /images/heroes/denver-hero.webp
latitude: 39.7392
longitude: -104.9903
region: CO
country: US
...
- id: mountains
  icon: ⛰️
  label: Mountain Ghosts
faqs:
- question: What happened at Cheesman Park?
  answer: Cheesman Park was built on the site of the old City Cemetery (Mount Prospect).
    When the city decided to relocate the cemetery in 1893, only 5,000 of the estimated
    5,000-10,000 burials were moved. The contractor hired to relocate the bodies was
...
<section class="py-16 md:py-20 bg-[#0f0a1a]">
    <div class="container px-4 mx-auto max-w-4xl">
      <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Why Denver Is Haunted</h2>
  ...
  <section id="brown-palace" class="py-12 md:py-16 relative overflow-hidden">
    ...
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl md:text-3xl font-bold text-white">The Brown Palace Hotel</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        ...
        <div class="my-8 py-8 text-center bg-gradient-to-b from-purple-950/[0.12] via-purple-950/[0.04] to-transparent rounded-xl">
          <div class="text-4xl md:text-5xl font-bold text-purple-400" style="font-family: 'Cinzel', serif; text-shadow: 0 0 30px rgba(168, 85, 247, 0.35), 0 0 60px rgba(168, 85, 247, 0.12);">1911</div>
          <p class="text-sm text-[#a89bb8] mt-2 tracking-wide uppercase">THE BROWN PALACE MURDER-SUICIDE</p>
        </div>
<p>
        ...
        <div class="my-8 border-l-4 border-purple-500/50 pl-6 pr-4 py-4 bg-purple-950/[0.15] rounded-r-lg">
          <p class="text-lg italic text-[#c4b5fd]/80">&ldquo;The city hired a contractor to relocate Cheesman’s graves at $1.90 per body — he stuffed remains into undersized coffins before abandoning the job entirely.&rdquo;</p>
        </div>
        <p>
...
<section id="lodo" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -right-24 top-1/3 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">🏚️</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">LoDo & Larimer Square</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
...
<section id="cemeteries" class="py-12 md:py-16 relative overflow-hidden">
    ...
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">⚰️</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Cheesman Park & Cemeteries</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
        ...
        <div class="my-8 py-8 text-center bg-gradient-to-b from-purple-950/[0.12] via-purple-950/[0.04] to-transparent rounded-xl">
          <div class="text-4xl md:text-5xl font-bold text-purple-400" style="font-family: 'Cinzel', serif; text-shadow: 0 0 30px rgba(168, 85, 247, 0.35), 0 0 60px rgba(168, 85, 247, 0.12);">5,000</div>
          <p class="text-sm text-[#a89bb8] mt-2 tracking-wide uppercase">BODIES NEVER RECOVERED FROM CHEESMAN PARK</p>
        </div>
        <p>
...
<section id="molly-brown" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -right-16 bottom-1/4 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">🚢</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Molly Brown House</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
...
<section id="mountains" class="py-12 md:py-16 relative overflow-hidden">
    <div class="absolute -left-20 bottom-1/3 w-72 h-72 bg-purple-900/[0.06] rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative z-10">
      <div class="flex items-center gap-3 mb-6">
        <span class="text-3xl">⛰️</span>
        <h2 class="text-2xl md:text-3xl font-bold text-white">Mountain Ghost Towns</h2>
      </div>
      <div class="text-gray-300 leading-relaxed space-y-4 bg-[#0d0816]/60 rounded-xl p-6 md:p-8 border border-purple-500/[0.06]">
        <p>
