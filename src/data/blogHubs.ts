...
export const BLOG_HUBS: Record<string, BlogHubData> = {
  'salem-witch-trials': {
    ...
    metaDescription:
      'Explore the full history of the Salem witch trials—who was accused, how the courts worked, why it ended, and what it teaches us about moral panic today.',
    intro:
    ...
    relatedDestinations: [{ name: "Salem's Haunted History", slug: 'salem' }],
    relatedCityHubs: [
      { name: 'Salem Ghost Tours', slug: 'salem' },
      { name: 'Boston Ghost Tours', slug: 'boston' },
    ],
    relatedBlogHubs: [{ name: 'American Prison History', slug: 'prison-history' }],
    faq: [
      {
  ...
  'vampire-culture': {
    ...
    metaDescription:
      "Explore vampire folklore, Bram Stoker's Dracula, real-life vampire legends, and how pop culture keeps reinventing the undead from Nosferatu to modern film.",
    intro:
    ...
    relatedDestinations: [{ name: "Dracula's Castle", slug: 'draculas-castle' }],
    relatedCityHubs: [
      { name: 'Dublin Ghost Tours', slug: 'dublin' },
      { name: 'London Ghost Tours', slug: 'london' },
    ],
    relatedBlogHubs: [{ name: 'Tower of London History', slug: 'tower-of-london' }],
    faq: [
      {
  ...
  'tower-of-london': {
    ...
    metaDescription:
      "Explore the Tower of London's dark history—executions, famous prisoners, the Crown Jewels, ghost sightings, and why this fortress still haunts the British imagination.",
    intro:
    ...
    relatedDestinations: [{ name: 'Tower of London', slug: 'tower-of-london' }],
    relatedCityHubs: [{ name: 'London Ghost Tours', slug: 'london' }],
    relatedBlogHubs: [
    ...
    faq: [
      {
        ...
        answer:
          'Only seven people were executed within the Tower walls (on Tower Green), including Anne Boleyn, Catherine Howard, and Lady Jane Grey. Many more were executed publicly on nearby Tower Hill.',
      },
      {
        question: 'What happened to the Princes in the Tower?',
        answer:
          "Edward V and his brother Richard disappeared from the Tower in 1483 after their uncle took the throne as Richard III. Their fate remains one of history's greatest unsolved mysteries, though most historians believe they were murdered.",
      },
    ],
  },
  ...
  'prison-history': {
    ...
    metaDescription:
      "Explore America's most notorious prisons—Eastern State Penitentiary, Alcatraz, and beyond. The history of solitary confinement, famous inmates, daring escapes, and paranormal claims.",
    intro:
  ...
  gettysburg: {
    ...
    metaDescription:
      "Explore the Battle of Gettysburg—tactics, casualties, aftermath, and the ghost stories that persist at America's bloodiest Civil War battlefield.",
    intro:
    ...
    relatedDestinations: [{ name: 'Gettysburg Battlefield', slug: 'gettysburg' }],
    relatedCityHubs: [
  ...
  'pop-culture': {
    ...
    metaDescription:
      "Explore the true stories behind haunted movies, real-life horror inspirations, urban legends, and the dark history that pop culture can't stop retelling.",
    intro:
    ...
    faq: [
      {
        ...
        answer:
          'Many iconic horror films draw from real events. The Exorcist was inspired by a 1949 exorcism case in Maryland. The Conjuring series is based on cases investigated by Ed and Lorraine Warren. The Texas Chain Saw Massacre drew inspiration from Wisconsin killer Ed Gein, who also inspired Psycho and Silence of the Lambs.',
      },
      {
        question: 'Are haunted house movies based on real places?',
        answer:
          "Several are. The Amityville Horror is based on the DeFeo murders and the Lutz family's claims about 112 Ocean Avenue. The Conjuring's farmhouse in Harrisville, Rhode Island is a real property. The Enfield Poltergeist case inspired multiple films including The Conjuring 2.",
      },
      {
        question: 'What is the connection between true crime and ghost tours?',
        answer:
          'Ghost tours often cover the same locations and events that true crime examines—murder sites, former prisons, places where violent deaths occurred. The difference is framing: true crime focuses on forensics and motive, while ghost tours layer in folklore and community memory that grew up around the same events.',
      },
    ],
  },
};
